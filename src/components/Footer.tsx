        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="flex flex-col items-center text-center max-w-md mx-auto mb-16">
            ...
            <p className="text-foreground/60 text-sm max-w-sm mb-6 leading-relaxed">
              LenV is the all-in-one school management software that connects schools, teachers, parents, and students. From attendance tracking and timetable management to parent-teacher communication and student performance analytics — one intelligent education platform for modern institutions.
            </p>
            <nav className="flex flex-wrap items-center justify-center gap-x-6 gap-y-2 text-sm text-foreground/50 mb-6" aria-label="Footer navigation">
              <a href="#features" className="hover:text-primary transition-colors">Features</a>
              <a href="#dashboards" className="hover:text-primary transition-colors">Dashboards</a>
              <a href="#about" className="hover:text-primary transition-colors">About LenV</a>
              <a href="#testimonials" className="hover:text-primary transition-colors">Testimonials</a>
              <a href="#faq" className="hover:text-primary transition-colors">FAQ</a>
            </nav>
            <div className="flex items-center justify-center gap-4 text-foreground/40">
              <a href="#" aria-label="Follow LenV on Twitter" className="hover:text-primary transition-colors">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 4s-.7 2.1-2 3.4c1.6 10-9.4 17.3-18 11.6 2.2.1 4.4-.6 6-2C3 15.5.5 9.6 3 5c2.2 2.6 5.6 4.1 9 4-.9-4.2 4-6.6 7-3.8 1.1 0 3-1.2 3-1.2z"/></svg>
              </a>
              <a href="#" aria-label="Connect with LenV on LinkedIn" className="hover:text-primary transition-colors">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"/><rect width="4" height="12" x="2" y="9"/><circle cx="4" cy="4" r="2"/></svg>
              </a>
              <a href="#" aria-label="Follow LenV on Instagram" className="hover:text-primary transition-colors">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="20" height="20" x="2" y="2" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" x2="17.51" y1="6.5" y2="6.5"/></svg>
              </a>
              <a href="#" aria-label="View LenV on GitHub" className="hover:text-primary transition-colors">
